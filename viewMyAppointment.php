<?php
	...
	$email=$_SESSION['email'];
	 ...
	 $query = "select time from appointments where email='$email';";
      ...
      <ul class="navbar-nav ml-auto ml-md-0">
        ...
        <li class="nav-item dropdown no-arrow">
          ...
          <div class="dropdown-menu dropdown-menu-right" aria-labelledby="userDropdown">
            ...
            <a class="dropdown-item" href="studentLogin.php" data-toggle="modal" data-target="#logoutModal">Logout</a>
          </div>
        </li>
      </ul>
      ...
      <div id="content-wrapper">
        ...
        <div class="container-fluid">
          ...
          <div class="card mb-3" style="margin-top: 150px;">
		   ...
		   <?php if($num==1){
			   echo "You have an appointment at ".$row['time'];
			   }
			   else{
				   echo "You dont have an Appointment.";
				   }?>
				   </h3>
