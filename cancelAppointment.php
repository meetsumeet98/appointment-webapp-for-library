<?php
	...
	$email=$_SESSION['email'];
	 ...
	 $num = mysqli_num_rows($result);
	  ...
	  if($num==1){
		 $q= "update appointments set email=null, reg_no=null, name=null, branch= null, year=null where email='$email';";
      ...
      <div id="content-wrapper">
        ...
        <div class="container-fluid">
          ...
          <div class="card mb-3" style="margin-top: 150px;">
           <h3 style="margin-left: 300px;"><?php echo "Appointment of ".$slot." Deleted Successfully."?></h3>
